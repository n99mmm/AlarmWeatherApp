...
#ifndef ALARMWEATHERAPP_SWIFT_H
#define ALARMWEATHERAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AlarmWeatherApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15AlarmWeatherApp8AppState")
...
@class CLLocation;
@interface AppState (SWIFT_EXTENSION(AlarmWeatherApp)) <CLLocationManagerDelegate>
...
@interface AppState (SWIFT_EXTENSION(AlarmWeatherApp)) <UNUserNotificationCenterDelegate>
